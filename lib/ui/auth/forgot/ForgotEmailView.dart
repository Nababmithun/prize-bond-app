...
/// FORGOT EMAIL VIEW
/// ---------------------------------------------------------------------------
/// - User enters email → triggers [AuthViewModel.forgotPassword]
/// - If success → navigates to Reset Password screen
/// ---------------------------------------------------------------------------
                  ...
                  SizedBox(
                    ...
                    child: ElevatedButton(
                      onPressed: _loading
                        ...
                        final ok = await vm.forgotPassword(emailVal);
                        ...
                        if (ok) {
                          ScaffoldMessenger.of(context).showSnackBar(
                            SnackBar(
                              content: Text(
                                vm.error ?? 'Verification code sent to your email',
                              ),
                            ),
                          );
                          ...
                          ScaffoldMessenger.of(context).showSnackBar(
                            SnackBar(
                              content: Text(
                                vm.error ?? 'Failed to send verification code',
                              ),
                            ),
                          );
                        }
